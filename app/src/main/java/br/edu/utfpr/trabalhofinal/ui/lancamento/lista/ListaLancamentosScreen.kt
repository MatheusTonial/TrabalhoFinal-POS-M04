...
private fun List(
    ...
    LazyColumn(modifier = modifier) {
        items(lancamentos) { lancamento ->
            ...
            //val descricao = "${lancamento.data.formatar()} - ${lancamento.descricao} - ${lancamento.valorFinal} - ${lancamento.pagoTxt}"
            val cor: Color = if(lancamento.tipo == TipoLancamentoEnum.RECEITA) Color(0xFF00984E) else Color(0xFFCF5355)
            ...
            ListItem(
                ...
                leadingContent = {
                    if (lancamento.paga) {
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.aberta),
                            tint = cor
                        )
                    }
                },
                ...
                trailingContent = {
                    Text(
                        text = lancamento.valorFinal.formatar(),
                        color = cor
                    )
                }
            )
